...
#        # If it is time, plan monitoring trajectory
#        if t != 0 and t % 25 < 1e-6:
#            agents[agentIdx].compute_mon_traj()
#            agents[agentIdx].mon_traj.plot(ax, showCpts=False)
#
#            idxs = list(range(params.nveh))
#            idxs.remove(agentIdx)
#            for j in idxs:
...
#                agents[j].send_traj(cpts_m, times_m)
#
#            agentIdx = (agentIdx + 1) % params.nveh
